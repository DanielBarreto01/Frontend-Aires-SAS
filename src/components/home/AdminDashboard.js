    ...
    return (
        <div className="container-fluid" style={{ height: '100vh' }}>
            ...
            <Navbar bg="light" expand="lg" className="border-bottom d-lg-none">
                <Navbar.Toggle aria-controls="basic-navbar-nav" onClick={() => setMenuOpen(!menuOpen)} className =" ms-2">
                    <FontAwesomeIcon icon={faBars} />
                </Navbar.Toggle>
                <Navbar.Brand href="#" className="mx-auto d-flex align-items-center">
                    <img src={logo} alt="Profile" className="profile-img" />
                    <span className="brand-text">P&A Aires Acondicionados</span>
                </Navbar.Brand>
                <Navbar.Collapse id="basic-navbar-nav" className={`slide-menu ${menuOpen ? 'open' : ''}`}>
